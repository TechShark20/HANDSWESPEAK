...
from isl import CzechSLRDataset
...
def get_default_args():
    ...
    parser.add_argument("--experiment_name", type=str, default="isladjectives",
                        help="Name of the experiment after which the logs and plots will be named")
    parser.add_argument("--num_classes", type=int, default=59, help="Number of classes to be recognized by the model")
    ...
    # Data
    parser.add_argument("--training_set_path", type=str, default="/content/isltrainfin.csv", help="Path to the training dataset CSV file")
    parser.add_argument("--testing_set_path", type=str, default="/content/isltestfin.csv", help="Path to the testing dataset CSV file")
    ...
    parser.add_argument("--validation_set_size", type=float,
                        help="Proportion of the training set to be split as validation set, if 'validation_size' is set"
                             " to 'split-from-train'")
    parser.add_argument("--validation_set_path", type=str, default="/content/islvalfin.csv", help="Path to the validation dataset CSV file")
...
def train(args):
    ...
    args.experiment_name = args.experiment_name + "_lr" 
